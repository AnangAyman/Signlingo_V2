...
class User(models.Model):
    ...
    # Number of quiz activities completed (drives the quiz achievement badge).
    quizzes_completed = models.IntegerField(default=0)
    # Number of AI camera sign predictions made (drives the AI Explorer badge).
    ai_practices_completed = models.IntegerField(default=0)
